...
class CashFlowIFRSReportCustomHandler(models.AbstractModel):
    _name = 'account.cash.flow.ifrs.report.handler'
        ...
        for column_group_key, column_group_options in report._split_options_per_column_group(options).items():
            ...
            queries.append(f'''
                SELECT
                    ...
                    SUM(ROUND(account_move_line.balance_cs)) AS balance
                FROM {tables}
        ...
        for column_group_key, column_group_options in report._split_options_per_column_group(options).items():
            ...
            queries.append(f'''
                ...
                SELECT
                    ...
                    SUM(ROUND(account_partial_reconcile.amount_cs)) AS balance
        ...
        for column_group_key, column_group_options in report._split_options_per_column_group(options).items():
            ...
            queries.append(f'''
                ...
                SELECT
                    ...
                    SUM(account_partial_reconcile.amount_cs) AS balance
        ...
        for column in options['columns']:
            queries.append(f'''
                SELECT
                    ...
                    account_move_line.move_id,
                    account_move_line.account_id,
                    SUM(account_move_line.balance_cs) AS balance
                FROM account_move_line
